...
export const EVENTS = [
  { title: "Fall Involvement Fair", date: "2026-08-27T17:00", location: "Tucker Civic Center",
    blurb: "Meet the CompNeuroSociety team at FSU's fall involvement fair - learn about our computational neuroscience workshops, project teams, and how to get involved, every major welcome." },
  { title: "Python Basics 4 Neuro/DataSci - Part 1", date: "2025-09-15T18:00", location: "TBA",
    blurb: "A beginner Python workshop with Codeducation - data types, loops, functions and plotting, from zero, no coding experience needed.",
    image: "images/python_coded.jpg" },
  { title: "Intro to ML/AI 4 NeuroSci", date: "2025-10-20T19:00", location: "WJB 2029",
    blurb: "A machine learning workshop for neuroscience - key concepts and real-world applications, perfect for beginners with no coding experience needed.",
    image: "images/mlworkshop.jpg" },
  { title: "A Conversation with Devon White, CEO of FIELD", date: "2025-10-09T17:45", location: "Virtual",
    blurb: "A CompNeuroSociety talk on how cutting-edge neurotechnology and brain-data processing are transforming human intelligence and potential.",
    image: "images/devonworkshop.jpg" },
  { title: "Python Basics 4 Neuro/DataSci - Part 2", date: "2025-09-18T18:00", location: "PDB A204",
    blurb: "A hands-on Python workshop with Codeducation - LFPs, spike-train plots, correlation and summary statistics on neural data.",
    image: "images/python_coded.jpg" },
  { title: "Python Basics 4 Neuro/DataSci - Part 1", date: "2025-09-16T18:00", location: "Thagard 211",
    blurb: "A beginner Python workshop with Codeducation - data types, loops, functions and basic plotting, no coding experience needed.",
    image: "images/python_coded.jpg" },
  { title: "Workshop on Computational Neuroscience", date: "2025-06-27T14:00", location: "PDB A204",
    blurb: "A computational neuroscience workshop on multi-level brain modeling and recent research, led by Dr. Rodrigo Pena from the FAU Stiles Nicholson Brain Institute.",
  ...
  { title: "Intro to Python, GitHub, VS Code Workshop", date: "2025-04-17T21:15", location: "FSU",
    blurb: "A beginner coding workshop covering Python, GitHub and VS Code - purpose, installation, and usage, no coding experience needed.",
    image: "images/placeholder.png" },
  { title: "Inaugural GBM", date: "2025-04-04T21:15", location: "FSU",
    blurb: "Our first General Body Meeting - CompNeuroSociety's mission, upcoming events, and the intersection of neuroscience and computing at FSU.",
...
export const PAST_PROJECTS = [
  ...
  { name: "Computational Retina Model Team", image: "images/projects/retina-model-1.jpg",
    summary: "An undergraduate research project that replicated a published computational model of the retina in NEURON - visual processing, modeling best practices and scientific reproducibility, with weekly learning sprints." },
];
